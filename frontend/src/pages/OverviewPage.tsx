...
const QUERY_GROUPS: { group: string; icon: string; queries: QueryDef[] }[] = [
  {
    ...
    queries: [
      ...
      { id: "top5_biomass",     label: "Top 5 Highest Biomass Trees",      group: "Tree Rankings", description: "Trees storing the most carbon biomass (latest scan)",   icon: "⚖️" },
  ...
  },
  {
    ...
    queries: [
      ...
      { id: "at_risk",          label: "Trees at Risk (High / Critical)",  group: "Growth & Health", description: "Trees classified as High or Critical risk based on decline indicators", icon: "⚠️" },
  ...
  },
  {
    ...
    queries: [
      ...
      { id: "first_scan_only",  label: "Trees Only in First Scan",        group: "Temporal Analysis", description: "Trees that appeared in the earliest scan but never again (potential deforestation)", icon: "🕰️" },
      ...
      { id: "most_scans",       label: "Trees with Most Scan Records",    group: "Temporal Analysis", description: "Trees tracked across the highest number of scan dates",        icon: "🗓️" },
    ],
  },
  {
    group: "🗺️ Sector / Spatial",
    icon: "🗺️",
    queries: [
